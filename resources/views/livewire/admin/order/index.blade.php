<div>
                    ...
                    <div class="flex w-full flex-wrap items-center">
                        <div class="w-full md:w-1/4 flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg"
                                class="icon icon-tabler icon-tabler-bread dark:text-secondary" width="40"
                                    ...
                                    <div class="flex justify-between w-full">
                                        <form class="w-full flex items-center justify-between" method="post">
                                            ...
                                            <div
                                                ...
                                                <button class="text-white rounded-md" type="button"><svg
        ...
        <div
            ...
            @if (!empty($order))
                ...
                <section id="cart">
                        ...
                        <div class="flex overflow-y-hidden scrolling-wrapper rounded-md py-2 bg-white dark:bg-dark">
                            <div class="w-full">
                                                ...
                                                <td>
                                                    <div
                                                        ...
                                                        <button class="text-white rounded-md"
                                                            onclick="
         const total_order = document.getElementById({{ $order_detail->id }});
    ...
    ">
                                        ...
                                        @endforelse
                                        <tr>
                                            <td align="right" colspan="4">Total Harga :
                                            </td>
                                            <td align="right">Rp.
                                                {{ number_format($order->total_order_price) }}
                                            </td>
                                            <td>
                                                <button onclick="updateData({{ $order->id }})"
                                                    class="btn btn-sm btn-success text-white"><svg
                                                        xmlns="http://www.w3.org/2000/svg"
                                                        class="icon icon-tabler icon-tabler-refresh" width="22"
                                                        height="22" viewBox="0 0 24 24" stroke-width="2"
                                                        stroke="currentColor" fill="none" stroke-linecap="round"
                                                        stroke-linejoin="round">
                                                        <path stroke="none" d="M0 0h24v24H0z" fill="none">
                        ...
                        <div class="flex">
                            <div class="w-full md:w-1/2 ml-auto md:px-4 rounded-md">
                                <div class="flex flex-col gap-2 justify-center rounded-md py-12 ">
                                    <div class="w-full">
                                        {{-- <form action="{{ route('admin.orders') }}"> --}}
                                        <label for="user"
                                            class="ml-1 font-semibold text-primary dark:text-secondary">Nama
                                            Pelanggan</label>
                                        <input type="text" class="input input-bordered w-full" id="search"
                                            name="search" placeholder="Cari nama pelanggan..">
                                        {{-- </form> --}}
    ...
    <div class="modal w-64 mx-auto bg-transparent">
        <div class="modal-box relative shadow-md">
            ...
            <div class="flex gap-4 justify-center items-center">
                <form
                    @if (!empty($order_detail)) action="{{ route('admin.orders.destroy', $order_detail->product->id) }}" @endif
                    method="post">
                    @csrf
                    @method('delete')
