                            ...
                            <div class="flex flex-wrap w-full items-center">
                                <div class="w-full md:w-1/2 mb-3 flex items-center">
                                    <svg xmlns="http://www.w3.org/2000/svg"
                                        class="icon icon-tabler icon-tabler-shopping-cart dark:text-secondary" width="40" height="40"
                                        ...
                                        <form action="" method="get">
                                            ...
                                            <div class="input-group">
                                                <input type="text" placeholder="Cari..." name="search"
                                                    class="input input-bordered w-full dark:text-white" value="{{ request('search') }}" />
                                                <button type="submit"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if ($customer->member === 2)
                                                        <span
                                                            class="bg-purple-500 rounded-full text-white  px-4 py-2">Anggur</span>
                                                    @elseif ($customer->member === 3)
                                                        <span
                                                            class="bg-red-900 rounded-full text-white  px-4 py-2">Cokelat</span>
                                                    @else
                                                        <span
                                                            class="bg-green-500 rounded-full text-white  px-4 py-2">Pandan</span>
                                                    @endif
                                                </td>
                                                <td>
