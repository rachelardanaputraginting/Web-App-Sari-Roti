@if ($paginator->hasPages())
    <nav role="navigation" aria-label="{{ __('Pagination Navigation') }}" class="flex items-center justify-end w-full mt-3">
        ...
        <div class="flex-1 flex items-center justify-between">
            ...
            <div>
                <span class="z-0 shadow-sm rounded-md flex justify-end ml-12">
                    {{-- Previous Page Link --}}
                    @if ($paginator->onFirstPage())
